...
import 'package:cleaning_hup/Screens/login_screen.dart';
...
class ClientProfile extends StatelessWidget {
  ClientProfile({Key? key, required this.token}) : super(key: key);
  final String token;
  var _data = {};

  @override
  Widget build(BuildContext context) {
    Uri _url = Uri.parse('https://cleaning.3m-erp.com/khadamaty/api/profile');
